...
def connect():
    return sqlite3.connect("data.db")  # will create the db if it's not created already


def create_tables(connection):
    with connection:  # context manager: ensure whatever we save to database is also saved to file
